...
<div class="well">
	<h1 class="grey lighter smaller">
		<span class="blue bigger-125"><i class="icon-sitemap"></i></span> 试用期超时！
	</h1>
	<hr />
	<h3 class="lighter smaller">System failure, please contact your administrator !</h3>
	<div>
		...
		-->
			<li><i class="icon-hand-right blue"></i> 试用期已用完，请及时联系平台管理员</li>
		</ul>
	</div>
	<hr />
	<div class="space"></div>
