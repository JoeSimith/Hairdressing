...
<!-- 		<span class="blue bigger-125"><i class="icon-sitemap"></i></span> 系统故障，请联系管理员！ -->
        <span class="blue bigger-125"><i class="icon-sitemap"></i></span> 正在开发中...
	</h1>
	<hr />
	<h3 class="lighter smaller">The website Page best is in the developing !</h3>
<!-- 	<div> -->
