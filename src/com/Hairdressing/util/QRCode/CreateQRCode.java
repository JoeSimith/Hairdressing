...
public class CreateQRCode {
	...
	/**
	 * 
	 * @param filepath  存放二维码的路径  例如："D:/qrcode.png"
	 * @param qrData  存放再二维码的内容  例如："https://www.baidu.com"
	 * @return 是否成功
	 * 
	 */
	public static boolean generate(String filepath,String qrData){
	    //计算二维码图片的高宽比
        ...
        //String qrData = "https://www.baidu.com";//内容信息
        ...
        try {
			...
			System.out.println("二维码输出写文件失败：" + filepath);
			e.printStackTrace();
		}
