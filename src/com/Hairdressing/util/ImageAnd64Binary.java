...
public class ImageAnd64Binary {
    public static void main(String[] args){
		...
		String imgCreatePath = "E:\\apache-tomcat-6.0.37\\webapps/pro/ueditor2/jsp/upload1/20140318/";     //将64编码生成图片的路径
        String imgName="480ace2bfc6e44608595bd4adbdeb067.jpg";
		imgCreatePath=imgCreatePath.replaceAll("\\\\", "/");
		System.out.println(imgCreatePath);
    	String strImg = getImageStr(imgSrcPath);
    	System.out.println(strImg);
        generateImage(strImg, imgCreatePath,imgName);
    }
   ...
   /**
     ...
     * @return
     */
    public static boolean generateImage(String imgStr, String imgCreatePath,String imgName){
        ...
        try {
            ...
            File tempFile = new File(imgCreatePath);
            if (!tempFile.exists()) {
                tempFile.mkdirs();
            }

            OutputStream out = new FileOutputStream(imgCreatePath+imgName);
            out.write(b);
            out.flush();
            out.close();
            return true;
