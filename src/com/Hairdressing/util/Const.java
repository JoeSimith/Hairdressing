...
public class Const {
	...
	public static final String NO_INTERCEPTOR_PATH = ".*/((login)|(addUser)|(plugins)|(logout)|(code)|(weixin)|(static)|(websocket)|(api)|(login_default)|(createCode)).*";	//不对匹配该值的访问路径拦截（正则）
