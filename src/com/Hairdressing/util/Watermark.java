...
public class Watermark {
			...
			if(null != strIWATERM && !"".equals(strIWATERM)){
				...
				if(strIW.length == 4){
					if("yes".equals(strIW[0])){
						pressImage(PathUtil.getClasspath() + Const.TEMPLATE_FILE_PATH+strIW[1], imagePath, Integer.parseInt(strIW[2]), Integer.parseInt(strIW[3]));
					}
				}
			}
		  } 
	...
	public static void main(String[] args) {
		String imagePath = "D:/tmp/Chrysanthemum.jpg";
		Watermark.setWatemark(imagePath);
	}
